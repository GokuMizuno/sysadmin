...
:: History:       1.6.3 * IMPROVEMENT:  Added pushd command to prep section to ensure we can run the script from a network drive
...
set JAVA_BINARY_x64=jre-8u5-windows-x64.exe
set JAVA_ARGUMENTS_x64=/s

:: JRE 32-bit reinstaller
set JAVA_LOCATION_x86=%~dp0
set JAVA_BINARY_x86=jre-8u5-windows-x86.exe
